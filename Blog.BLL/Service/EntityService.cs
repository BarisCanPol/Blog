using Blog.BLL.Repository.Entity;
using System;
...
namespace Blog.BLL.Service
{
    public class EntityService
    {
        ...
        { get { return _appUserService; } set { _appUserService = value; } }

        private CommentRepository _commentService;
        public CommentRepository CommentService      
            { get { return _commentService; } set { _commentService = value; } }

        private LikeRepository _likeService;
        public LikeRepository LikeService { get { return _likeService; } set { _likeService = value; } }
    }
}
